...
namespace mario{
	...
	void clusterize( const pcl::PointCloud<pcl::PointXYZRGBA>::ConstPtr & cloud,  pcl::PointCloud<pcl::PointXYZRGBA>::Ptr & dst, vector<  pcl::PointCloud<pcl::PointXYZRGBA>::Ptr >& v_dst );
